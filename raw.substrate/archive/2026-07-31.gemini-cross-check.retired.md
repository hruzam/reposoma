<!-- ARCHIVED VERBATIM 2026-07-31 · was reposoma/.claude/agents/gemini-cross-check.md · fate: RETIRED — BlueBottle claude-wiring 1984'd. Role obsolete: Claude Sonnet 1M native context killed Gemini's context-window edge; nabla-lab found the Gemini leg unreliable (lags/stucks, triage 2026-07-03 Class C hang). Successor for the synth role: @Field (in-house Sonnet). BlueBottle itself STAYS in the Gemini harness as ears-and-eyes (keyboard launchers untouched). -->
---
