...
| subai.devenv | office | cleared 🟢 | _pending — basement/atlas_ | `PROJECT.yaml` · `flag.md` |
...
| piql.dev | office | active | _pending — reshape from raw.projects_ | `raw.projects/raw.project.piql.dev.md` (legacy) |
