# Research Brief — R3 · ChatGPT (Cursor CLI)

`voice: R3 · runtime: ChatGPT under Cursor CLI · method: blind cross-brand triangulation`
`date: 2026-06-17 · phase: fresh blind design loop`

You are **one independent research voice of several**, answering blind. You have not seen, and should not try to infer, what any other voice produces. Independence is the whole value of your answer — do not converge toward what you imagine a "standard" reply would be. Give the most honest, well-reasoned, independent design you can from the first principles below.
